...
add_action('wp_ajax_my_action', 'Pscheme\Tyrannosaurus\App\Http\action_callback');
add_action('wp_ajax_nopriv_my_action', 'Pscheme\Tyrannosaurus\App\Http\action_callback');
