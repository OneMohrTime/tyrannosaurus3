...
namespace Pscheme\Tyrannosaurus\App\Http;
...
use function Pscheme\Tyrannosaurus\App\asset_path;
...
add_action('wp_enqueue_scripts', 'Pscheme\Tyrannosaurus\App\Http\register_stylesheets');
...
add_action('wp_enqueue_scripts', 'Pscheme\Tyrannosaurus\App\Http\register_scripts');
...
add_action('admin_init', 'Pscheme\Tyrannosaurus\App\Http\register_editor_stylesheets');
...
add_action('wp_default_scripts', 'Pscheme\Tyrannosaurus\App\Http\move_jquery_to_the_footer');
