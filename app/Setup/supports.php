...
add_action('after_setup_theme', 'Pscheme\Tyrannosaurus\App\Setup\add_theme_supports');
...
add_action('after_setup_theme', 'Pscheme\Tyrannosaurus\App\Setup\load_textdomain');
